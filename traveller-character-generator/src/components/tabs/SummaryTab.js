...
export default function SummaryTab() {
  ...
  const getTotalTerms = () => {
    return character.careerHistory.reduce(
      (total, career) => total + career.terms,
      0
    );
  };
  ...
  const getHighestRank = () => {
    ...
    const highestRankCareer = character.careerHistory.reduce(
      (highest, career) => (career.rank > highest.rank ? career : highest)
    );
  ...
  const getHighestSkill = () => {
    ...
    const [skillName, level] = Object.entries(character.skills).reduce(
      ([maxSkill, maxLevel], [skill, level]) =>
    ...
    <div className="summary-tab">
      ...
      <div className="character-sheet">
                    ...
                    <div className="career-events-summary">
                      ...
                      <ul>
                        {career.events.map((event, eventIndex) => (
                          <li key={eventIndex}>
                            Term {event.term}: {event.description}
                          </li>
                        ))}
                      </ul>
                    </div>
        ...
        <div className="health-summary">
          <h4>Health</h4>
          <p>
            <strong>Physical Damage:</strong> {character.damage.current} /{' '}
        ...
        <div className="character-statistics">
          ...
          <div className="stats-grid">
            ...
            <div className="stat-item">
              ...
              <span className="stat-value">{getTotalTerms() * 4} years</span>
            </div>
            <div className="stat-item">
              <span className="stat-label">Benefit Rolls Earned:</span>
              <span className="stat-value">{character.benefitRolls}</span>
            </div>
            <div className="stat-item">
