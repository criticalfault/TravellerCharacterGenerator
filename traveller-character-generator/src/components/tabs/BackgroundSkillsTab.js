...
export default function BackgroundSkillsTab() {
  ...
  const resetAllSkills = () => {
    if (
      window.confirm('Are you sure you want to reset all background skills?')
    ) {
  ...
  return (
    <div className="background-skills-tab">
      ...
      <p>
        Select background skills based on your character's education and early
        life. You have <strong>{availablePoints}</strong> skill points to spend
        ({basePoints} base + Education DM of {educationDM >= 0 ? '+' : ''}
        {educationDM}).
      </p>
        ...
        <div className="skill-actions">
          ...
          >
            {character.backgroundSkillsSelected
              ? 'Background Skills Complete'
              : 'Finish Background Skills'}
          </button>
        </div>
      </div>
      ...
      <div className="selected-skills">
        ...
        {Object.keys(character.skills).length > 0 ? (
          ...
          <p>
            No skills selected yet. Choose from the available background skills
            above.
          </p>
        )}
      </div>
      ...
      <div className="background-info">
        ...
        <div className="info-grid">
          <div className="info-item">
            ...
            <p>
              Background skills represent training and experience gained before
              beginning your career. These skills are typically learned through
              education, hobbies, or early life experiences.
            </p>
          </div>
          <div className="info-item">
            <strong>Skill Points Calculation:</strong>
            <p>
              You receive 3 base skill points plus your Education DM. Higher
              education provides more opportunities to learn diverse skills.
          ...
          <div className="info-item">
            ...
            <p>
              Background skills can be raised to a maximum of level 3. Each
              level represents increasing competency in that skill area.
            </p>
          </div>
          <div className="info-item">
            <strong>Skill Usage:</strong>
            <p>
              These skills will be available throughout your character's career
              and adventures. They provide bonuses to related skill checks and
      ...
      {character.backgroundSkillsSelected && (
        <div className="completion-notice">
          ...
          <p>
            You have finished selecting your background skills. You can now
