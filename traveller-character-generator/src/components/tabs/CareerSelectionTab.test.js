...
describe('CareerSelectionTab', () => {
  ...
  test('renders career selection interface', () => {
    ...
    expect(
      screen.getByText(/Choose your first career path/)
    ).toBeInTheDocument();
  ...
  test('can select a career', () => {
    ...
    expect(
      screen.getByText(/Choose your specialization within the agent career/)
    ).toBeInTheDocument();
  });
  ...
  test('shows assignment options when career is selected', () => {
    ...
    const assignmentSection = screen
      ...
      .closest('.assignment-selection');
    expect(
      assignmentSection.querySelector('button[class*="assignment-btn"]')
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Choose your specialization within the.*agent.*career/)
    ).toBeInTheDocument();
  ...
  test('can decline commission and remain enlisted', async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText('You chose to remain in the enlisted ranks.')
      ).toBeInTheDocument();
    });
  });
  ...
  test('displays career information section', () => {
    ...
    expect(
      screen.getByText(/Each career offers different skills/)
    ).toBeInTheDocument();
