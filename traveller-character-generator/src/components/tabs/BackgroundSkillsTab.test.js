...
describe('BackgroundSkillsTab', () => {
  test('renders background skills section', () => {
    ...
    expect(
      screen.getByText(
        /Select background skills based on your character's education/
      )
    ).toBeInTheDocument();
  });
  ...
  test('shows skill descriptions when toggled', () => {
    ...
    expect(
      screen.queryByText(
        'Bureaucracy, paperwork, and organizational management'
      )
    ...
    expect(
      screen.getByText('Bureaucracy, paperwork, and organizational management')
    ).toBeInTheDocument();
  ...
  test('can reset all skills', () => {
    ...
    expect(window.confirm).toHaveBeenCalledWith(
      'Are you sure you want to reset all background skills?'
    );
  });
  ...
  test('can finish background skills selection', () => {
    ...
    expect(
      screen.getByRole('heading', { name: 'Background Skills Complete' })
    ).toBeInTheDocument();
    expect(
      screen.getByText(
        'You have finished selecting your background skills. You can now proceed to career selection.'
      )
    ).toBeInTheDocument();
  });
  ...
  test('shows selected skills summary', () => {
    ...
    expect(
      screen.getByText(
        'No skills selected yet. Choose from the available background skills above.'
      )
    ).toBeInTheDocument();
  ...
  test('displays skill information section', () => {
    ...
    expect(
      screen.getByText('Background Skills Information')
    ).toBeInTheDocument();
